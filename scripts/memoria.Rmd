...
Podemos comprobar que, pese a eliminar dichas variables, el modelo empeora.
...
Prácticamente, obtuvimos el mismo resultado eliminando el año de _date_recorded_, __por lo que se decidió no tener en cuenta dicha variable, al no aportar mejoría alguna__.
...
3. ___Feature Engineering_: _cyear_, _dist_, _cant_agua_, _dr_month_ y _dr_year_cyear_diff ___
...
7. _subsample_ o porcentaje de "submuestra" a escoger durante el entrenamiento.
...
```{r, echo=FALSE}
knitr::include_graphics("../charts/xgboost_subsample.png")
```
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8260, 0.8265, 0.8257, 0.8260),
...
color_me <- which(puntuaciones$Data.Submission == 0.8265)
kable(puntuaciones) %>%
  kable_styling() %>%
  row_spec(color_me, bold = TRUE, background = "#4D934D")
```
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8265, 0.8256, 0.8244, 0.8272),
...
color_me <- which(puntuaciones$Data.Submission == 0.8272)
kable(puntuaciones) %>%
  kable_styling() %>%
  row_spec(color_me, bold = TRUE, background = "#4D934D")
```
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8265, 0.8256, 0.8244, 0.8272, 0.8261, 0.8266),
  row.names = c("colsample_bytree = 0.3 & colsample_bylevel = 0.9",
  "colsample_bytree = 0.3 & colsample_bylevel = 0.9 & colsample_bynode = 0.9",
  "colsample_bytree = 0.3 & colsample_bylevel = 0.9 & colsample_bynode = 0.8",
  "colsample_bytree = 0.3 & colsample_bylevel = 0.9 & colsample_bynode = 0.7",
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8251, 0.8253, 0.8272),
  row.names = c("Mejor score Feature Egineering",
  "Mejor score Random Forest",
  "Mejor score XGboost"))
...
knitr::include_graphics("../h2o_ai.png")
```
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8272, 0.8255),
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8251, 0.8253, 0.8272, 0.8206),
  row.names = c("Mejor score Feature Egineering",
  "Mejor score Random Forest",
  "Mejor score XGboost",
  "autoxgboost"))
...
```{r, echo=FALSE}
puntuaciones <- data.frame("Data Submission" = c(0.8251, 0.8253, 0.8272, 0.8206, 0.8101, 
