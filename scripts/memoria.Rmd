...
# Mantenemos las columnas en el mismo orden original
cols <- c("basin", "region", "lga", "scheme_management", "extraction_type", "extraction_type_group",
          "extraction_type_class", "management", "management_group", "payment", "payment_type", 
          "water_quality", "quality_group", "quantity", "quantity_group", "source", 
          "source_type", "source_class", "waterpoint_type", "waterpoint_type_group"
          )
datcat_gd <- datcat_gd[, cols]
```
...
fwrite(dattrainOrlab, "./train_values_concurso.csv")
fwrite(dattestOr    , "./test_values_concurso.csv" )
```
...
puntuaciones <- data.frame("Train accuracy" = c(0.8168687, 0.8101178, 0.8105724, 0.8122391, 0.8114983, 0.8124579, 0.8135017), 
                        "Data Submission" = c(0.8128, 0.8096, 0.8081, 0.8174, 0.8176, 0.8176, 0.8174),
                row.names = c("Num + Cat (> 1 & < 1000) sin duplicados",
...
Sobre dicho modelo, se ha obtenido una mejor puntuación de 0.8133502 en el conjunto _train_ y 0.8184 en el conjunto de prueba, por lo que el objetivo consistirá en superar dicho _accuracy_, así como la mejor puntuación obtenida por el grupo ganador (0.8248).
...
dattrainOrlab    <- fread(file = "./train_values_concurso.csv", data.table = FALSE )
dattestOr        <- fread(file = "./test_values_concurso.csv", data.table = FALSE  )
```
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832), 
                        "Data Submission" = c(0.8174, 0.8197),
...
fwrite(datcompleto, file = "./datcompleto_clean_text.csv")
```
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212),
                        row.names = c("Mejor accuracy en el concurso",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
...
```{r, echo=FALSE}
# Guardamos el dataset
fwrite(datcompleto, file = "./datcompleto_clean_text_lumping_mediana.csv")
```
...
```{r}
datcompleto <- fread("./datcompleto_clean_text.csv")
```
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8159259, 0.8146633), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212, 0.8196, 0.8203),
                        row.names = c("Mejor accuracy en el concurso",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (mediana)",
...
```{r}
datcompleto <- fread("./datcompleto_clean_text_lumping_mediana.csv")
```
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8159259, 0.8146633, 0.8158418), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212, 0.8196, 0.8203, 0.8214),
                        row.names = c("Mejor accuracy en el concurso",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (mediana)",
                                      "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (primer cuartil)",
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8146633, 0.8159259, 0.8158418, 0.8154882), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212, 0.8203, 0.8196, 0.8214, 0.8216),
                        row.names = c("Mejor accuracy en el concurso",
                        "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (mediana)",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (tercer cuartil)",
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8146633, 0.8159259, 0.8158418, 0.8154882, 0.8154377), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212, 0.8203, 0.8196, 0.8214, 0.8216, 0.8164),
                        row.names = c("Mejor accuracy en el concurso",
                        "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (mediana)",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (tercer cuartil)",
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8146633, 0.8159259, 0.8158418, 0.8154882, 0.8154377, 0.814899), 
                        "Data Submission" = c(0.8174, 0.8197, 0.8212, 0.8203, 0.8196, 0.8214, 0.8216, 0.8164, 0.8215),
                        row.names = c("Mejor accuracy en el concurso",
                        "Num + Cat (> 1 & < 2100) fe anteriores + fe_funder + fe_ward",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (mediana)",
                        "Num + Cat (> 1 & < 2100) fe anteriores + lumping sobre funder + ward (tercer cuartil)",
...
fwrite(datcompleto, 
       file = "./datcompleto_clean_text_lumping_mediana_freq_abs_cat_menos_installer.csv")
```
...
```{r, echo=FALSE}
datcompleto <- fread("./datcompleto_clean_text_lumping_mediana_freq_abs_cat_menos_installer.csv")
...
puntuaciones <- data.frame("Train accuracy" = c('-', 0.8149832, 0.8159764, 0.8146633, 0.8159259, 
                        ...
                        "Data Submission" = c(0.8184, 0.8197, 0.8212, 0.8203, 0.8196, 0.8214, 0.8216, 0.8164, 0.8215,
