...
# guardo submission
fwrite(my_sub_10, file = "./submissions/10_lumping_fe_freq_abs_sobre_funder_ward.csv")
# 0.8216
...
#-- Conclusion: reduciendo el numero de categorias (en mayor medida que en hashing, conseguimos obtener un mejor scoring: 0.8216)
#   ¿Y si aplicamos la imputacion al resto de variables categoricas (characters)?
