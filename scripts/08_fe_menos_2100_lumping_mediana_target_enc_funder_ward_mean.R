...
# Codificamos la variable objetivo en formato numerico
...
train[, fe_funder := NULL]; train[, fe_ward := NULL]
test[, fe_funder := NULL]; test[, fe_ward := NULL]
...
# guardo submission
fwrite(my_sub_12, file = "./submissions/12_lumping_fe_sobre_funder_ward_target_encoding_media.csv")
# 0.8164
