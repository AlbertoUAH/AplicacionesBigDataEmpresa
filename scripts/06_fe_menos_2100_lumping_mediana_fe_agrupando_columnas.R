...
datcompleto[, fe_extraction := paste(extraction_type, extraction_type_group, extraction_type_class, sep = "_+_")]
datcompleto[, fe_source := paste(source, source_type, source_class, sep = "_+_")]

#-- Eliminamos las columnas empleadas
set(datcompleto, ,c("waterpoint_type", "waterpoint_type_group", 
                   "extraction_type", "extraction_type_group",
                   "extraction_type_class", "source", 
                   "source_type", "source_class"), NULL)
...
# guardo submission
fwrite(my_sub_10, file = "./submissions/10_05_lumping_sobre_funder_ward_comprimir_waterpoint_extraction_source.csv")

# 0.8199

knitr::kable(data.frame("Train accuracy" = c(0.8168687, 0.8101178, 0.8122391, 0.8124579, 0.8122727, 0.8149832, 0.8159764, 0.8146633, 0.8162121, 0.8158418, 0.8156397), 
                        "Data Submission" = c(0.8128, 0.8096, 0.8174, 0.8176, 0.8168, 0.8197, 0.8213, 0.8203, 0.8198, 0.8195, 0.8199),
