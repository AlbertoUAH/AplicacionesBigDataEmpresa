...
include_graphics("./charts/h2o_ai.png")
```
...
```{r, echo=FALSE, out.width="15%", out.height="15%"}
include_graphics("./charts/hexagon_logo.svg")
```
...
```{r, echo=FALSE}
include_graphics("./charts/submission.png")
```

```{r, echo=FALSE}
include_graphics("./charts/leaderboard.png")
```
